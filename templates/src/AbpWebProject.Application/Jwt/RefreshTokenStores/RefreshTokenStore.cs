...
namespace AbpWebProject.Application.Jwt.RefreshTokenStores
{
    /// <summary>
    /// 刷新令牌存储
    /// </summary>
    public class RefreshTokenStore : EfCoreRepository<AbpWebProjectDbContext, RefreshToken, Guid>, IRefreshTokenStore
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name="dbContextProvider"></param>
        public RefreshTokenStore(IDbContextProvider<AbpWebProjectDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
